                    ...
                    <div class="video__wrapper">
                        <div class="video__video-item">
                            <video poster="<?php echo get_template_directory_uri() ?>/assets/video/poster.jpg" controls>
                                <source type="video/webm" src="<?php echo get_template_directory_uri() ?>/assets/video/intro.webm">
                                <source type="video/mp4" src="<?php echo get_template_directory_uri() ?>/assets/video/intro.mp4">
                            </video>
                        </div>
